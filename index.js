...
// Enregistrement des utilisateurs dans le stockage local
localStorage.setItem("user1", JSON.stringify(user1));
localStorage.setItem("user2", JSON.stringify(user2));
localStorage.setItem("user3", JSON.stringify(user2.pwd));


// Lecture des utilisateurs depuis le stockage local
const storedUser1 = JSON.parse(localStorage.getItem("user1"));
const storedUser2 = JSON.parse(localStorage.getItem("user2"));
const storedUser3 = JSON.parse(localStorage.getItem("user3"));

console.log("Utilisateur 1:", storedUser1);
console.log("Utilisateur 2:", storedUser2);
console.log("Utilisateur 3:", storedUser3);
